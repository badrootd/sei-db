...
// source: fork.memiavl/changelog.proto
...
func init() {
	proto.RegisterType((*NamedChangeSet)(nil), "fork.memiavl.NamedChangeSet")
	proto.RegisterType((*TreeNameUpgrade)(nil), "fork.memiavl.TreeNameUpgrade")
	proto.RegisterType((*MultiTreeMetadata)(nil), "fork.memiavl.MultiTreeMetadata")
	proto.RegisterType((*ChangelogEntry)(nil), "fork.memiavl.ChangelogEntry")
}

func init() { proto.RegisterFile("fork.memiavl/changelog.proto", fileDescriptor_39ab2c074e463b59) }
