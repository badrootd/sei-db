...
// source: fork.memiavl/commit_info.proto
...
func init() {
	proto.RegisterType((*CommitInfo)(nil), "fork.memiavl.CommitInfo")
	proto.RegisterType((*StoreInfo)(nil), "fork.memiavl.StoreInfo")
	proto.RegisterType((*CommitID)(nil), "fork.memiavl.CommitID")
}

func init() { proto.RegisterFile("fork.memiavl/commit_info.proto", fileDescriptor_11dece027dbaaf68) }
